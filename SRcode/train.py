...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument('file_path', type=str, nargs='?', default='configs/stss_extra_warp.yaml', help="Path to the config file")
...
def write_vsr_frames(writer: SummaryWriter, step: int, buffer_dict: dict[str, bool], lr_image: torch.Tensor,
